...
public:
	...
	Vector_alloc_base(const allocator_type& __a) : _M_data_allocator(__a), start(0), finish(0), end_of_storage(0) {}
...
public:
	...
	size_type	capacity() const { size_type(const_iterator(_M_end_of_storage) - begin()); }
